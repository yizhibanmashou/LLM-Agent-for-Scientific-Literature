# Chapter 21 Textbook Mapping

## chapter21_001 · 21: Family-Based Selection
...
## chapter21_002 · 21: Family-Based Selection / INTRODUCTION TO FAMILY-BASED SELECTION SCHEMES
...
## chapter21_003 · 21: Family-Based Selection / Overview of the Different Types of Family-based Selection
...
## chapter21_004 · 21: Family-Based Selection / Plant Versus Animal Breeding
...
## chapter21_005 · 21: Family-Based Selection / Among- Versus Within-family Selection
...
## chapter21_006 · 21: Family-Based Selection / Selection and Recombination Units
...
## chapter21_007 · 21: Family-Based Selection / Variations of the Selection Unit
...
> **Example 21.1** · ref: `21.1` · source: `chapter21_007.json` · blocks 6–6
>
...
## chapter21_008 · 21: Family-Based Selection / Variations of the Recombination Unit
...
## chapter21_009 · 21: Family-Based Selection / THEORY OF EXPECTED SINGLE-CYCLE RESPONSE
...
## chapter21_010 · 21: Family-Based Selection / Modifications of the Breeder's Equation for Predicting Family-based Response
...
> **Example 21.2** · ref: `21.2` · source: `chapter21_010.json` · blocks 3–3
>
...
> 
> Tables Table 21.3 and Table 21.4 (below) give expressions for these variances and covariances.
> 
...
## chapter21_011 · 21: Family-Based Selection / Modifications of the Breeder's Equation for Predicting Family-based Response
...
## chapter21_012 · 21: Family-Based Selection / The Selection Unit-offspring Covariance, $ \sigma(x, y) $
...
> **Table 21.3** · `21.3` · page 14 · source: `chapter21_012`
...
> --- | ---
> Family selection ( $ \mathcal{R}_{1} $ is a measured sib from family i) | $$ \sigma \left(\bar {z} _ {i}, y \mid \mathcal {R} _ {1}\right) = r _ {n} \left(\sigma_ {A} ^ {2} / 2\right) = \left\{ \begin{array}{l l} (1 + 3 / n) \left(\sigma_ {A} ^ {2} / 8\right) & \mathrm {h a l f - s i b s} \\ (1 + 1 / n) \left(\sigma_ {A} ^ {2} / 4\right) & \mathrm {f u l l - s i b s} \end{array} \right. $$
> Sib selection / Remnant seed ( $ \mathcal{R}_{1} $ is an unmeasured sib from family i ) | $$ \sigma \left(\bar {z} _ {i}, y \mid \mathcal {R} _ {1}\right) = r \left(\sigma_ {A} ^ {2} / 2\right) = \left\{ \begin{array}{l l} \sigma_ {A} ^ {2} / 8 & \mathrm {h a l f - s i b s} \\ \sigma_ {A} ^ {2} / 4 & \mathrm {f u l l - s i b s} \end{array} \right. $$
> Parental selection / Progeny testing ( $ \mathcal{R}_{1} $ is a parent of the measured sibs) | $$ \sigma \left(\bar {z} _ {i}, y \mid \mathcal {R} _ {1}\right) = \sigma_ {A} ^ {2} / 4 $$


---

## chapter21_013 · 21: Family-Based Selection / Among-family Selection:
...
## chapter21_014 · 21: Family-Based Selection / Within-family Selection:
...
## chapter21_015 · 21: Family-Based Selection / Variance of the Selection Unit, $ \sigma_{x}^{2} $
...
## chapter21_016 · 21: Family-Based Selection / Variance of the Selection Unit, $ \sigma_{x}^{2} $
...
> **Example 21.3** · ref: `21.3` · source: `chapter21_016.json` · blocks 5–5
>
...
## chapter21_017 · 21: Family-Based Selection / RESPONSE FOR PARTICULAR DESIGNS
...
## chapter21_018 · 21: Family-Based Selection / Overview of Among- and Within-family Response
...
## chapter21_019 · 21: Family-Based Selection / Among-family Selection:
...
$$ R_{b}(HS)=(\sigma_{A}h)\frac{r_{n}}{\sqrt{t_{n}}}\cdot\bar{\imath}_{HS}=1.70\frac{0.311}{\sqrt{0.165}}\cdot1.27=1.67 $$ while the expected response to full-sib family selection is $$ R_{b}(FS)=1.70\ \frac{0.542}{\sqrt{0.326}}\cdot1.33=2.15 $$
...
## chapter21_021 · 21: Family-Based Selection / Among-family Selection: Which Scheme Is Best?
...
## chapter21_022 · 21: Family-Based Selection / Within-family Selection:
...
> **Example 21.5** · ref: `21.5` · source: `chapter21_022.json` · blocks 7–7
>
...
## chapter21_023 · 21: Family-Based Selection / Realized Heritabilities
...
## chapter21_024 · 21: Family-Based Selection / Accounting for Epistasis
...
Table 21.2 shows that $ \Theta_{xy} = 1/16 $ and $ 1/8 $ when $ x $ is a half- or full-sib, respectively, of $ \mathcal{R} $. Expressed in terms of Wright's coefficient of relationship, $ r $, (21.27b)
...
## chapter21_025 · 21: Family-Based Selection / Response with Autotetraploids
...
## chapter21_026 · 21: Family-Based Selection / Response with Autotetraploids

**[示例 Example]**

> **Example 21.6** · ref: `21.6` · source: `chapter21_026.json` · blocks 0–0
>
...
> 
> > **Formula (21.34a)** · `21.34a` · source: `chapter21_block_159` · Response with Autotetraploids
> >
...
> 
> > **Formula (21.34b)** · `21.34b` · source: `chapter21_block_160` · Response with Autotetraploids
> >
...
> 
> > **Formula (21.34c)** · `21.34c` · source: `chapter21_block_162` · Response with Autotetraploids
> >
...
> 
> 
> With a parent-offspring relationship, exactly two alleles are IBD, so that $ \pi_{2} = 1 $. With half-sibs, by looking at the 36 entries in the $ 6 \times 6 $ table of pairs of gametes from the same parent, we see that 6 share two alleles, 24 share one, and 6 share zero. Hence, $ \pi_{1} = 24/36 = 2/3 $, $ \pi_{2} = 6/36 = 1/6 $. Results for full-sibs follow from these half-sib results. Let $ P_{1} $ and $ P_{2} $ denote the shared parents. The probability that four alleles are shared is the probability the sibs share two alleles from $ P_{1} $ times the probability they share two alleles from $ P_{2} $, or $ \pi_{4} = (1/6)(1/6) $, assuming the parents are unrelated and not inbred. Now consider the case of sharing exactly two alleles IBD. This can happen in three different ways: sharing one IBD allele from each parent (probability [2/3][2/3]), sharing two IBD alleles from $ P_{1} $ and zero from $ P_{2} $ (probability [1/6][1/6]), or sharing two alleles from $ P_{2} $ and zero from $ P_{1} $ (probability [1/6][1/6]), yielding $$ \pi_{2}=\left(2/3\right)^{2}+\left(1/6\right)^{2}+\left(1/6\right)^{2}=18/36=1/2 $$
> 
> Similar logic yields $ \pi_{1}=2/9 $ and $ \pi_{3}=2/9 $. To summarize, Substitution of the above results for the $ \pi_{i} $ into the general expression for the covariance yields Equation 21.32a.


**[示例 Example]**

> **Example 21.7** · ref: `21.7` · source: `chapter21_026.json` · blocks 1–1
>
...
> 
> > **Table 21.6** · `21.6` · page 36 · source: `chapter21_026`
...
> 
> 
> When $x$ and $\mathcal{R}$ are half-sibs, Example 21.6 shows that $2/3$ of sibs share one IBD allele, while $1/6$ share two. We let the notation $(I[x,y]=1)$ and $(I[x,y]=2)$ denote that the pair $(x,y)$ share, respectively, exactly one or two IBD alleles. Using the above table, the probability that $y$ and $x$ share one or two IBD alleles becomes $$ \begin{aligned}\pi_{1}=\Pr(\mathrm{I}[x,y]=1|\mathrm{I}[x,\mathcal{R}]=1)\Pr(\mathrm{I}[x,\mathcal{R}]=1)+\Pr(\mathrm{I}[x,y]=1|\mathrm{I}[x,\mathcal{R}]=2)\Pr(\mathrm{I}[x,\mathcal{R}]=2)\\=(1/2)(2/3)+(2/3)(1/6)=4/9\end{aligned} $$ $$ \pi_{2}=\Pr(\mathrm{I}[x,y]=2\mid\mathrm{I}[x,\mathcal{R}]=2)\ \Pr(\mathrm{I}[x,\mathcal{R}]=2)=(1/6)(1/6)=1/36 $$
> 
> Substituting these into Equation 21.34c returns
> 
> > **Formula (21.34d)** · `21.34d` · source: `chapter21_block_166` · Response with Autotetraploids
> >
...
> 
> When x and R are full-sibs, Example 21.6 showed that the probability they share one, two, three, and four IBD alleles is 2/9, 1/2, 2/9, and 1/36, respectively. Following the same logic and using the above table, $$ \pi_{1}=(1/2)(2/9)+(2/3)(1/2)+(1/2)(2/9)+(0)(1/36)=20/36=5/9 $$ $$ \pi_{2}=(0)(2/9)+(1/6)(1/2)+(1/2)(2/9)+(1)(1/36)=2/9 $$ yielding
> 
> > **Formula (21.34e)** · `21.34e` · source: `chapter21_block_167` · Response with Autotetraploids
> >
...
## chapter21_027 · 21: Family-Based Selection / EFFICIENCY OF FAMILY-BASED VS. INDIVIDUAL SELECTION
...
## chapter21_028 · 21: Family-Based Selection / The Relative Accuracies of Family-based vs. Individual Selection
...
## chapter21_029 · 21: Family-Based Selection / The Relative Accuracies of Family-based vs. Individual Selection
...
## chapter21_030 · 21: Family-Based Selection / Comparing Selection Intensities: Finite Size Corrections
...
Table 21.6 statistics. The correction for mass selection is generally very small and will be ignored here (see Equation 21.57b). Within-family deviations are negatively correlated within a family, $ (\rho = -1/[n - 1] $ for a family of size $ n $), as they are deviations from a common family mean. As a result, Dempfle (1990) and Hill et al. (1996) found that the resulting selection intensity for within-family deviations is thus slightly larger than the intensity for mass selection $ \bar{\nu}_m $, with
...
## chapter21_031 · 21: Family-Based Selection / Within-family Selection Has Additional Long-term Advantages
...
## chapter21_032 · 21: Family-Based Selection / RESPONSE WHEN FAMILIES ARE REPLICATED OVER ENVIRONMENTS
...
## chapter21_033 · 21: Family-Based Selection / Among-family Variance Under Replication
...
## chapter21_035 · 21: Family-Based Selection / Modified Ear-to-Row Selection
...
> **Example 21.10** · ref: `21.10` · source: `chapter21_035.json` · blocks 6–6
>
...
## chapter21_036 · 21: Family-Based Selection / SELECTION ON A FAMILY INDEX
...
## chapter21_037 · 21: Family-Based Selection / Response to Selection on a Family Index
...
## chapter21_038 · 21: Family-Based Selection / Lush's Optimal Index
...
> **Example 21.12** · ref: `21.12` · source: `chapter21_038.json` · blocks 6–6
>
...
> 
> If we further recall that the family size was n = 12, the optimal weight on family means becomes $$ b_{2}=\frac{1+(n-1)r}{1+(n-1)t}=\frac{1+(12-1)0.5}{1+(12-1)0.265}=1.66 $$
> 
> We can rescale the weights as $ b_{1}=1 $ and $ b_{2}=1.66/0.680=2.44 $, with Equation 21.53c returning an expected response of $$ R_{L I}=\bar{\imath}_{L I}\sigma_{A}h\rho(I,y)=1.39\cdot1.70\cdot\left(\frac{1+0.542(2.44-1)}{\sqrt{1^{2}+0.326(2.44^{2}-1^{2})}}\right)=2.60 $$
> 
> The expected response under individual selection was $ R_{m} = 2.36 $ (Example 21.11), so the expected response under the Lush index is 10% greater than that of mass selection.


---

## chapter21_039 · 21: Family-Based Selection / Lush's Optimal Index
...
## chapter21_040 · 21: Family-Based Selection / Correcting the Selection Intensity for Correlated Variables
...
> **Formula (21.58a)** · `21.58a` · source: `chapter21_block_244` · Correcting the Selection Intensity for Correlated Variables
>
...
> **Formula (21.58b)** · `21.58b` · source: `chapter21_block_245` · Correcting the Selection Intensity for Correlated Variables
>
