...
## Evolution_chapter20_001 · Selection Response in Natural Populations: Introduction
...
$$
^{ }p<0.05,\qquad^{ }p<0.01,\qquad^{ }p<0.001
$$
...
> **Figure 20.1** · page 5 · source: `Evolution_chapter20`
>
> ![Figure 20.1](figures/Evolution_20.1.png)
>
...
$$
S {alkaloid level}=\sigma(alkaloid level,soil nitrate)\beta {soil nitrate}\neq0
$$

**[推导 Derivation]**

$$
R {alkaloid level}=\sigma(A {alkaloid level},A {soil nitrate})\beta {soil nitrate}=0\cdot\beta {soil nitrate}=0
$$
...
$$
\mathbf{R}=\mathbf{G}\mathbf{P}^{-1}\mathbf{S}=\mathbf{G}\boldsymbol{\beta}
$$
...
## Evolution_chapter20_005 · Selection Response in Natural Populations: Introduction / THE FISHER-PRICE-KIRKPATRICK-ARNOLD MODEL FOR EVOLUTION OF BREEDING DATE
...
> **Figure 20.2** · page 6 · source: `Evolution_chapter20`
>
> ![Figure 20.2](figures/Evolution_20.2.png)
>
...
## Evolution_chapter20_006 · Selection Response in Natural Populations: Introduction / MODIFYING THE BREEDER'S EQUATION FOR NATURAL POPULATIONS
...
## Evolution_chapter20_007 · MODIFYING THE BREEDER'S EQUATION FOR NATURAL POPULATIONS / Complications in the Absence of Environmental Change
...
> **Figure 20.3** · page 8 · source: `Evolution_chapter20`
>
> ![Figure 20.3](figures/Evolution_20.3.png)
>
...
The left-most vector contains the covariances between relative fitness, w, and the predictor variables $ (z, A, \text{ and } E) $, with $ S = \sigma(w, z) $ following from the Robertson-Price identity
...
## Evolution_chapter20_008 · MODIFYING THE BREEDER'S EQUATION FOR NATURAL POPULATIONS / Additional Complications From Environmental Change
...
## Evolution_chapter20_009 · Selection Response in Natural Populations: Introduction / IS A FOCAL TRAIT THE DIRECT TARGET OF SELECTION?
...
## Evolution_chapter20_011 · IS A FOCAL TRAIT THE DIRECT TARGET OF SELECTION? / Robertson Consistency Tests
...
## Evolution_chapter20_012 · IS A FOCAL TRAIT THE DIRECT TARGET OF SELECTION? / Rausher's Consistency Criteria
...
$$
b_{z}=b_{A}=b_{A}h^{2}+b_{E}(1-h^{2}),\quad or\quad b_{A}(1-h^{2})=b_{E}(1-h^{2})
$$
...
## Evolution_chapter20_013 · IS A FOCAL TRAIT THE DIRECT TARGET OF SELECTION? / Morrissey et al.'s Consistency Criteria

An alternative expression for consistency can be obtained as follows. Writing

$$
\sigma(z,w)=\sigma(A_{z}+E_{z},A_{w}+e_{w})=\sigma(A_{z},A_{w})+\sigma(E_{z},e_{w})+\sigma(A_{z},e_{w})+\sigma(E_{z},A_{w})
$$

where $ E_z = z - A_z $ is the residual trait value after the removal of the breeding value, with $ e_w = w - A_w $ similarly defined. Likewise noting that $ \sigma(A_z, w) = \sigma(A_z, A_w) + \sigma(A_z, e_w) $, the consistency condition given by Equation 20.16b becomes
...
$$
1+\frac{\sigma(E_{z},e_{w})+\sigma(E_{z},A_{w})}{\sigma(A_{z},A_{w})+\sigma(A_{z},e_{w})}=1+\frac{\sigma^{2}(E_{z})}{\sigma^{2}(A_{z})}
$$

implying

$$
\frac{\sigma(E_{z},e_{w})+\sigma(E_{z},A_{w})}{\sigma(A_{z},A_{w})+\sigma(A_{z},e_{w})}=\frac{\sigma^{2}(E_{z})}{\sigma^{2}(A_{z})}
$$
...
## Evolution_chapter20_014 · IS A FOCAL TRAIT THE DIRECT TARGET OF SELECTION? / The Breeder’s Equation Versus the Secondary Theorem
...
## Evolution_chapter20_015 · Selection Response in Natural Populations: Introduction / APPLYING MIXED MODELS TO NATURAL POPULATIONS: BASICS
...
## Evolution_chapter20_016 · APPLYING MIXED MODELS TO NATURAL POPULATIONS: BASICS / Animal-model Analysis in Natural Populations: Overview
...
The animal model has generally been quite successful in the analysis of artificial selection experiments and breeding programs (Chapter 19). However, natural populations differ in fundamental ways from these more controlled settings, leading to a number of design issues (*[See Table 20.1 at the end of this section.]*). First, in natural populations, the relationship matrix must be ascertained indirectly, and this is usually done with a bias toward finding mother-offspring (maternal) links, while missing (or misspecifying) father-offspring (paternal) connections.
...
> **Table 20.1** · `20.1` · page None · source: `Evolution_chapter20_016`
...
## Evolution_chapter20_017 · APPLYING MIXED MODELS TO NATURAL POPULATIONS: BASICS / Obtaining the Relationship Matrix: Direct Observation of the Pedigree
...
## Evolution_chapter20_018 · APPLYING MIXED MODELS TO NATURAL POPULATIONS: BASICS / Obtaining the Relationship Matrix: Marker Data
...
## Evolution_chapter20_019 · APPLYING MIXED MODELS TO NATURAL POPULATIONS: BASICS / Consequences of Pedigree Errors
...
> **Figure 20.4** · page 30 · source: `Evolution_chapter20`
>
> ![Figure 20.4](figures/Evolution_20.4.png)
>
...
## Evolution_chapter20_020 · APPLYING MIXED MODELS TO NATURAL POPULATIONS: BASICS / Model Selection
...
*[See Table 20.2 at the end of this section.]* reduction of power. At a minimum, one strategy is to present analyses under a series of models (even if the resulting variance components may not be significant) if they result in substantially different interpretations of key results.

**[Table]**

*[See Table 20.2 at the end of this section.]*

> **Table 20.2** · `20.2` · page 28 · source: `Evolution_chapter20_020`
...
## Evolution_chapter20_021 · Selection Response in Natural Populations: Introduction / APPLYING MIXED MODELS TO NATURAL POPULATIONS: BASICS
...
## Evolution_chapter20_022 · APPLYING MIXED MODELS TO NATURAL POPULATIONS / Consistency Tests: Accuracy, Reliability, and Caveats when Using PBVs
...
$$
\rho_{i}^{2}=1-\left(\frac{P E V_{i i}}{\sigma^{2}(A)}\right)
$$
...
$$
S_{A}=\sigma(A,w)=S_{\hat{a}}=\sigma(\widehat{a},w)
$$
...
## Evolution_chapter20_023 · APPLYING MIXED MODELS TO NATURAL POPULATIONS / Bivariate Animal Models: REML Estimates of $ \sigma(A_{z}, A_{w}), S_{A} $, and $ S_{z} $
...
## Evolution_chapter20_024 · APPLYING MIXED MODELS TO NATURAL POPULATIONS / Next-generation Analysis: Generalized Mixed Models
...
## Evolution_chapter20_025 · APPLYING MIXED MODELS TO NATURAL POPULATIONS / Next-generation Analysis: Modeling Missing Data
...
> **Figure 20.5** · page 35 · source: `Evolution_chapter20`
>
> ![Figure 20.5](figures/Evolution_20.5.png)
>
...
## Evolution_chapter20_026 · APPLYING MIXED MODELS TO NATURAL POPULATIONS / Detecting Genetic Trends
...
> **Figure 20.6** · page 36 · source: `Evolution_chapter20`
>
> ![Figure 20.6](figures/Evolution_20.6.png)
>
...
> **Figure 20.7** · page 37 · source: `Evolution_chapter20`
>
> ![Figure 20.7](figures/Evolution_20.7.png)
>
...
> **Table 20.3** · `20.3` · page 40 · source: `Evolution_chapter20_027`
...
> **Table 20.4** · `20.4` · page 41 · source: `Evolution_chapter20_027`
...
## Evolution_chapter20_028 · CAUSES OF APPARENT FAILURES OF RESPONSE IN NATURAL POPULATIONS / Cryptic Evolution: Genetic Change Masked by Environmental Change
...
> **Figure 20.9** · page 42 · source: `Evolution_chapter20`
>
> ![Figure 20.9](figures/Evolution_20.9.png)
>
...
## Evolution_chapter20_029 · CAUSES OF APPARENT FAILURES OF RESPONSE IN NATURAL POPULATIONS / Antler Size in Red Deer: The Focal Trait Is Not the Target of Selection
...
## Evolution_chapter20_030 · CAUSES OF APPARENT FAILURES OF RESPONSE IN NATURAL POPULATIONS / Lower Heritabilities in Environments with Stronger Selection?
...
## Evolution_chapter20_031 · CAUSES OF APPARENT FAILURES OF RESPONSE IN NATURAL POPULATIONS / Fitness Tradeoffs and Multivariate Constraints
