...
## chapter5_003 · The Population Genetics of Selection: Introduction / Viability Selection
...
> **Example 5.1** · ref: `5.1` · source: `chapter5_003.json` · blocks 5–5
>
> Example 5.1. Letting $ p = \text{freq}(A) $, what is $ \Delta p $ when $ W_{AA} = 1 + 2s $, $ W_{Aa} = 1 + s $, and $ W_{aa} = 1 $? These are additive fitnesses, with each copy of allele A adding an amount $ s $ to the fitness. In this case, mean fitness simplifies to $ \overline{W} = 1 + 2sp $ (there is an average of $ 2p $ A alleles per individual, each of which increments fitness by $ s $), and applying Equation 5.1c (setting $ h = 0 $) yields $$ \Delta p=\frac{sp(1-p)}{1+2sp} $$
> 
> Noting that a first-order Taylor expansion (in s) yields $ 1/(1+2sp)=1-2sp+O(s^{2}) $, for $ |s| $ small, we have
> 
> > **Formula (5.2b)** · `5.2b` · source: `chapter5_block_014` · Viability Selection
> >
...
## chapter5_004 · The Population Genetics of Selection: Introduction / Expected Time for Allele-frequency Change
...
> **Example 5.2** · ref: `5.2` · source: `chapter5_004.json` · blocks 3–3
>
> Example 5.2. Consider the time for a favored allele to move from a frequency of 0.1 to a frequency of 0.5. For an additive allele, Equation 5.3d yields $$ t\simeq s^{-1}\ln\left(\frac{0.5\left(1-0.1\right)}{0.1\left(1-0.5\right)}\right)=\frac{2.2}{s}\; generations $$
> 
...
## chapter5_005 · The Population Genetics of Selection: Introduction / Differential Viability Selection on the Sexes
...
## chapter5_006 · The Population Genetics of Selection: Introduction / Frequency-dependent Selection
...
## chapter5_007 · The Population Genetics of Selection: Introduction / Fertility/Fecundity Selection
...
## chapter5_008 · The Population Genetics of Selection: Introduction / Sexual Selection
...
> **Example 5.4** · ref: `5.4` · source: `chapter5_009.json` · blocks 3–3
>
...
> **Example 5.5** · ref: `5.5` · source: `chapter5_009.json` · blocks 4–4
>
...
> 
> A sample of 12,387 West Africans yielded 9365 NN, 2993 NS, and 29 SS individuals (Nussbaum et al. 2004), giving a frequency of S as $$ \frac{(1/2)\cdot2993+29}{12,387}=0.123 $$
...
> **Example 5.6** · ref: `5.6` · source: `chapter5_010.json` · blocks 2–2
>
...
> 
> > **Formula (5.6a)** · `5.6a` · source: `chapter5_block_046` · WRIGHT'S FORMULA
> >
...
> 
> > **Formula (5.6b)** · `5.6b` · source: `chapter5_block_046` · WRIGHT'S FORMULA
> >
...
> 
> > **Formula (5.6c)** · `5.6c` · source: `chapter5_block_047` · WRIGHT'S FORMULA
> >
> > $$ \mu=m+2\sum_{i=1}^{n}a_{i}p_{i}\qquad and\qquad\sigma^{2}=2\sum_{i=1}^{n}a_{i}^{2}p_{i}\left(1-p_{i}\right)+\sigma_{E}^{2} $$
> 
> 
> where the additive-genetic variance expression (LW Equation 4.23b) assumes no linkage disequilibrium. From Equation 5.6c,
> 
> > **Formula (5.6d)** · `5.6d` · source: `chapter5_block_047` · WRIGHT'S FORMULA
> >
> > $$ \frac{\partial\mu}{\partial p_{i}}=2a_{i}\qquad\mathrm{a n d}\qquad\frac{\partial\sigma^{2}}{\partial p_{i}}=2a_{i}^{2}\left(1-2p_{i}\right) $$
> 
> 
> Wright’s formula (Equation 5.5b) returns the expected change in the frequency of allele $ B_{i} $ as $$ \Delta p_{i}=\frac{p_{i}(1-p_{i})}{2}\left(\frac{\partial\ln W}{\partial p_{i}}\right) $$ which, upon substituting Equation 5.6d into Equation 5.6b, yields
> 
> > **Formula (5.6e)** · `5.6e` · source: `chapter5_block_048` · WRIGHT'S FORMULA
> >
...
> 
> > **Formula (5.6f)** · `5.6f` · source: `chapter5_block_049` · WRIGHT'S FORMULA
> >
...
## chapter5_011 · The Population Genetics of Selection: Introduction / Adaptive Topographies and Wright's Formula
...
## chapter5_013 · The Population Genetics of Selection: Introduction / Marginal Fitnesses and Average Excesses
...
## chapter5_014 · The Population Genetics of Selection: Introduction / Equilibrium Frequencies With Multiple Alleles
...
## chapter5_015 · The Population Genetics of Selection: Introduction / Internal, Corner, and Edge Equilibria and Basins of Attraction
...
## chapter5_016 · The Population Genetics of Selection: Introduction / Wright's Formula With Multiple Alleles
...
## chapter5_017 · The Population Genetics of Selection: Introduction / Changes in Genotypic Fitnesses, $ W_{ij} $, When Additional Loci are Under Selection
...
## chapter5_019 · The Population Genetics of Selection: Introduction / Dynamics of Gamete-frequency Change
...
> **Table 5.2** · `5.2` · page 20 · source: `chapter5_019`
...
> **Example 5.8** · ref: `5.8` · source: `chapter5_019.json` · blocks 6–6
>
...
## chapter5_020 · The Population Genetics of Selection: Introduction / Gametic Equilibrium Frequencies, Linkage Disequilibrium, and Mean Fitness
...
## chapter5_021 · The Population Genetics of Selection: Introduction / Results for Particular Fitness Models
...
> **Example 5.10** · ref: `5.10` · source: `chapter5_021.json` · blocks 3–3
>
...
## chapter5_022 · The Population Genetics of Selection: Introduction / Phenotypic Stabilizing Selection and the Maintenance of Genetic Variation
...
> **Example 5.11** · ref: `5.11` · source: `chapter5_022.json` · blocks 3–3
>
...
> 
> Thus, provided allelic effects are uneven and selection is strong relative to recombination, selection can maintain both alleles at both loci (Kearsey 1968; Kearsey and Gale 1968; Nagylaki 1989a; Gavrilets and Hastings 1993, 1994a, 1994b). Gavrilets and Hastings showed that, with strong selection, the mean trait value at equilibrium does not necessarily coincide with the optimum fitness value, so in general $ \hat{\mu}_z \neq 0 $. Hence, at equilibrium, there can be the appearance of apparent directional selection.
> 
...
## chapter5_024 · The Population Genetics of Selection: Introduction / Monogenic Traits
...
## chapter5_025 · The Population Genetics of Selection: Introduction / Many Loci of Small Effect Underlying the Character
...
## chapter5_026 · The Population Genetics of Selection: Introduction / A Population-genetic Derivation of the Breeder's Equation
...
> **Example 5.12** · ref: `5.12` · source: `chapter5_026.json` · blocks 5–5
>
...
## chapter5_027 · The Population Genetics of Selection: Introduction / Correct Quadratic Terms for $ s_{i} $
...
> **Example 5.13** · ref: `5.13` · source: `chapter5_027.json` · blocks 6–6
>
> Example 5.13. To obtain Equation 5.26b, we first substitute Equation 5.26a into Equation 5.25b
> 
> > **Formula (5.28a)** · `5.28a` · source: `chapter5_block_147` · Correct Quadratic Terms for $ s_{i} $
> >
...
> 
> > **Formula (5.28b)** · `5.28b` · source: `chapter5_block_148` · Correct Quadratic Terms for $ s_{i} $
> >
> > $$ \begin{aligned}(z-\mu)^{2}&=[(z-\mu^{*})+(\mu^{*}-\mu)]^{2}\\&=(z-\mu^{*})^{2}+2(z-\mu^{*})(\mu^{*}-\mu)+(\mu^{*}-\mu)^{2}\end{aligned} $$
> 
> 
> > **Formula (5.28c)** · `5.28c` · source: `chapter5_block_148` · Correct Quadratic Terms for $ s_{i} $
> >
...
> 
> 
> with Equation 5.28a becoming Noting that $\int w(z)p(z) = \overline{w} = 1$ and that $\int f(z)w(z)p(z) = E_s[f(z)]$, namely, the expected value of $f(z)$ in the selected individuals (as $w(z)p(z)$ is the distribution of $z$ following selection), Equation 5.28c reduces to $$ \begin{aligned}I_{2}&=\frac{1}{\sigma_{z}^{4}}\Biggl(-\sigma_{z}^{2}+E_{s}[(z-\mu^{*})^{2}]+2(\mu^{*}-\mu)E_{s}(z-\mu^{*})+(\mu^{*}-\mu)^{2}\Biggr)\\&=\frac{1}{\sigma_{z}^{4}}\Biggl(-\sigma_{z}^{2}+\sigma_{z^{*}}^{2}+0+S^{2}\Biggr)\end{aligned} $$
> 
