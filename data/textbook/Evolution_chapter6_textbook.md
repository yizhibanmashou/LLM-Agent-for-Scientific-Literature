...
## Evolution_chapter6_004 · Theorems of Natural Selection: Results of Price, Fisher, and Robertson: Introduction / The Robertson-Price Identity, $ S = \sigma(w, z) $
...
## Evolution_chapter6_005 · PRICE'S GENERAL THEOREM OF SELECTION / The Breeder's Equation, $ R = h^{2} S $
...
$$
p_{j}^{\prime}=p_{j}+\Delta p_{j}\quad\mathrm{a n d}\quad b_{j}^{\prime}=b_{j}+\Delta b_{j}
$$
...
## Evolution_chapter6_006 · Theorems of Natural Selection: Results of Price, Fisher, and Robertson: Introduction / FISHER'S FUNDAMENTAL THEOREM OF NATURAL SELECTION
...
## Evolution_chapter6_007 · FISHER'S FUNDAMENTAL THEOREM OF NATURAL SELECTION / The Classical Interpretation of Fisher's Fundamental Theorem, $ R_w = \sigma_A^2(w) $
...
## Evolution_chapter6_008 · FISHER'S FUNDAMENTAL THEOREM OF NATURAL SELECTION / What Did Fisher Really Mean?
...
## Evolution_chapter6_009 · Theorems of Natural Selection: Results of Price, Fisher, and Robertson: Introduction / IMPLICATIONS OF FISHER'S THEOREM FOR TRAIT VARIATION
...
## Evolution_chapter6_010 · IMPLICATIONS OF FISHER'S THEOREM FOR TRAIT VARIATION / Traits Correlated With Fitness Have Lower Heritabilities
...
> **Table 6.2** · `6.2` · page 18 · source: `Evolution_chapter6_010`
...
## Evolution_chapter6_011 · IMPLICATIONS OF FISHER'S THEOREM FOR TRAIT VARIATION / Traits Correlated With Fitness Have Higher Levels of Both Additive and Residual Variance
...
## Evolution_chapter6_012 · IMPLICATIONS OF FISHER'S THEOREM FOR TRAIT VARIATION / Nonadditive Genetic Variance for Traits Under Selection
...
## Evolution_chapter6_013 · ROBERTSON'S SECONDARY THEOREM OF NATURAL SELECTION / 1968 Version: $ R_{z} = \sigma_{A}(w, z) $
...
Likewise, under the fundamental theorem (Equation 6.17c), $ \Delta A_w = \sigma^2(A_w) $. Substituting these two results into Equation 6.24b recovers Robertson’s 1968 version of his theorem,

$$
R_{z}=\left(\frac{\sigma(A_{w},A_{z})}{\sigma^{2}(A_{w})}\right)\sigma^{2}(A_{w})=\sigma(A_{w},A_{z})
$$

---

## Evolution_chapter6_014 · Theorems of Natural Selection: Results of Price, Fisher, and Robertson: Introduction / 1966 Version: $ R_{z} = \sigma(w, A_{z}) $
...
## Evolution_chapter6_015 · ROBERTSON'S SECONDARY THEOREM OF NATURAL SELECTION / Accuracy of the Secondary Theorem
...
$$
R_{z,k}=2\sum_{j}\alpha_{j}s_{j}p_{j}+\sum_{i,j}\delta_{ij}p_{i}s_{i}p_{j}s_{j}
$$
...
## Evolution_chapter6_016 · ROBERTSON'S SECONDARY THEOREM OF NATURAL SELECTION / Connecting Robertson’s Results With Those of Price, Fisher, and Lush
...
## Evolution_chapter6_017 · Theorems of Natural Selection: Results of Price, Fisher, and Robertson: Introduction / THE BREEDER'S EQUATION FRAMED WITHIN THE PRICE EQUATION

**[推导 Derivation]**

$$
\sigma(e {w},e {\overline{{z}}})=\sigma(w,\overline{{z}} z)
$$
...
$$
R_z=\beta_{\bar{z}z}S+\sigma(w,\bar{z}\mid z)+E(\bar{\delta})
$$

Thus, even when the parent-offspring regression is nonlinear, we can express the selection response in trait z as a linear response (breeder's equation) term $ \beta {\overline{z} z}S $ plus a correction $ \sigma(w,\overline{z} z)=\sigma(e w,e {\overline{z}}) $ accounting for (among other things) nonlinearity and an additional correction $ E(\overline{\delta}) $ for transmission. Because $ \sigma(w,\overline{z} z) $ removes the (linear) effect of parental value $ z i $, on both its offspring mean $ \overline{z} i $ and its own relative fitness, $ w i $, any residual association between $ w i $ and $ \overline{z} i $ is uncorrelated with $ z i $ and hence uncorrelated with selection on the parent. Thus, the response from this component need not be adaptive, leading Heywood to denote $ \sigma(w,\overline{z} z) $ as the spurious response to selection.

There are two ways to generate a nonzero $ \sigma(w, \overline{z} \parallel z) $. First, both regressions $ (w i \text{ on } z i \text{ and } \overline{z} i \text{ on } z i) $ may be nonlinear, and, as a result, their residuals may be correlated, generating a spurious response (e.g., Figure 6.5). Second, even if one (or both) of these regressions is linear, if both $ w i $ and $ \overline{z} i $ are correlated through an unmeasured variable (such as an environmental
...
$$
\begin{aligned}\sigma(w,\bar{z})&=\sigma(w,\bar{z}\mid z)+\beta_{\bar{z}z}\sigma(w,z)\\ &=\sigma(w,\bar{z}\mid z)+\beta_{\bar{z}z}S\end{aligned}
$$

effect), their residuals, after being regressed on $ z {i} $, can still be correlated, again generating a potentially spurious response (Chapter 20 examines this process in more detail).
...
## Evolution_chapter6_018 · THE BREEDER'S EQUATION FRAMED WITHIN THE PRICE EQUATION / Partial Covariance and the Spurious Response to Selection
...
## Evolution_chapter6_019 · THE BREEDER'S EQUATION FRAMED WITHIN THE PRICE EQUATION / Parent-Offspring Regressions Before and After Selection
...
> **Table 6.3** · `6.3` · page 28 · source: `Evolution_chapter6_019`
...
## Evolution_chapter6_020 · THE BREEDER'S EQUATION FRAMED WITHIN THE PRICE EQUATION / Hence
...
## Evolution_chapter6_021 · THE BREEDER'S EQUATION FRAMED WITHIN THE PRICE EQUATION / Heywood's Decomposition of Response
