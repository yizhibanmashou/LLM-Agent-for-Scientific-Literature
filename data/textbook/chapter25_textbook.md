...
## chapter25_002 · 25: Introduction / IDEALIZED LONG-TERM RESPONSE IN A LARGE POPULATION
...
## chapter25_003 · 25: Introduction / DETERMINISTIC SINGLE-LOCUS THEORY
...
## chapter25_004 · 25: Introduction / Expected Contribution From a Single Locus
...
## chapter25_005 · 25: Introduction / Dudley's Estimators of a, n, and $ p_{0} $
...
## chapter25_006 · 25: Introduction / Dynamics of Allele-frequency Change
...
> **Example 25.2** · ref: `25.2` · source: `chapter25_006.json` · blocks 2–2
>
...
> **Example 25.3** · ref: `25.3` · source: `chapter25_006.json` · blocks 3–3
>
> Example 25.3. An ingenious experiment examining the fit between estimated QTL effects and their projected allele-frequency changes under selection was performed by Falke et al. (2007). By making crosses between inbred lines, the frequency of all segregating alleles in the $ F_1 $ is 1/2. Assuming only additive effects, for $ p = 1/2 $, Equation 25.3 reduces to $ \Delta p = a \bar{i} / (4\sigma_z) $. Further, the expected frequency change at a marker allele linked to $ n $ QTLs is
> 
> > **Formula (25.5)** · `25.5` · source: `chapter25_block_028` · Dynamics of Allele-frequency Change
> >
> > $$ \Delta p_{m}=\frac{\overline{\imath}}{4\sigma_{z}}\sum_{i=1}^{n}a_{i}(1-2c_{i}) $$
> 
> 
> where $ c_{i} $ is the recombination frequency between the ith-marker and the QTL (this expression is only approximate, as it ignores LD among the linked QTLs and quickly breaks down if more than a couple of QTL are linked to the marker).
> 
...
## chapter25_007 · 25: Introduction / MAJOR GENES VERSUS POLYGENIC RESPONSE: THEORY
...
## chapter25_008 · 25: Introduction / Lande's Model: Response With a Major Gene in an Infinitesimal Background
...
Table 25.2 $$ \overline{W}_{i}=\int w(z)\varphi(z,\mu+\alpha_{i},\sigma^{2})d z\quad for i=0,1,2 $$

Mean fitness: $$ \begin{aligned}\overline{W}&=(1-p)^{2}W_{bb}+2p(1-p)W_{Bb}+p^{2}W_{BB}\\&=(1-p)^{2}\overline{W}_{0}+2p(1-p)(1-s_{1})\overline{W}_{1}+p^{2}(1-s_{2})\overline{W}_{2}\end{aligned} $$

Mean phenotype: $$ \overline{z}=\mu\left(1+2\alpha_{1}p(1-p)+\alpha_{2}p^{2}\right) $$
...
## chapter25_009 · 25: Introduction / Lande's Model: Response With a Major Gene in an Infinitesimal Background
...
> **Example 25.5** · ref: `25.5` · source: `chapter25_009.json` · blocks 8–8
>
...
## chapter25_010 · 25: Introduction / MAJOR GENES VERSUS POLYGENIC RESPONSE: DATA
...
## chapter25_011 · 25: Introduction / Major Genes Appear to Be Important in Response to Anthropogenically Induced Selection
...
## chapter25_012 · 25: Introduction / What is the Genetic Architecture of Response in Long-term Selection Experiments?
...
## chapter25_013 · 25: Introduction / AN OVERVIEW OF LONG-TERM SELECTION EXPERIMENTS
...
## chapter25_014 · 25: Introduction / Estimating Selection Limits and Half-lives
...
## chapter25_015 · 25: Introduction / General Features of Long-term Selection Experiments
...
## chapter25_016 · 25: Introduction / The Nature of Selection Limits
...
> **Table 25.4** · `25.4` · page 24 · source: `chapter25_016`
...
Several strategies can be used to break an apparent selection limit and allow for further response. Relaxing selection for several generations followed by directional selection can break a limit caused by strong gametic-phase disequilibrium between segregating loci. Likewise, if the limit results

**[示例 Example]**

> **Example 25.9** · ref: `25.9` · source: `chapter25_016.json` · blocks 8–8
>
...
> 
> > **Inline Table 2** · `inline_2` · page 35 · source: `chapter25_016`
> > Inline Table 2
> >
...
## chapter25_017 · 25: Introduction / INCREASES IN VARIANCES AND ACCELERATED RESPONSES
...
## chapter25_018 · 25: Introduction / Rare Alleles
...
## chapter25_019 · 25: Introduction / Major Mutations
...
## chapter25_020 · 25: Introduction / Scale and Environmental Impacts on Variances
...
## chapter25_021 · 25: Introduction / Linkage Effects
...
## chapter25_022 · 25: Introduction / Epistasis
...
## chapter25_023 · 25: Introduction / CONFLICTS BETWEEN NATURAL AND ARTIFICIAL SELECTION
...
> **Example 25.6** · ref: `25.6` · source: `chapter25_023.json` · blocks 6–6
>
...
> **Example 25.8** · ref: `25.8` · source: `chapter25_023.json` · blocks 8–8
>
...
## chapter25_024 · 25: Introduction / Accumulation of Lethals in Selected Lines
...
> **Formula (25.12a)** · `25.12a` · source: `chapter25_block_126` · Accumulation of Lethals in Selected Lines
>
...
> **Formula (25.12b)** · `25.12b` · source: `chapter25_block_127` · Accumulation of Lethals in Selected Lines
>
...
> **Example 25.10** · ref: `25.10` · source: `chapter25_024.json` · blocks 7–7
>
> Example 25.10. For a more formal treatment of the expected equilibrium value, consider a major gene that is lethal as a recessive (BB), but increases character value as a heterozygote (Bb). What are the dynamics of this locus when truncation selection is used to increase character value? Suppose that the distribution of phenotypes for the two viable genotypes is normal, with $ z_{Bb} \sim N(\mu + a, \sigma^2) $ and $ z_{bb} \sim N(\mu, \sigma^2) $, and let p be the frequency of B. Following random mating, the expected zygotic frequencies will be in Hardy-Weinberg frequencies, with $ freq(Bb) = 2p(1 - p) $, $ freq(bb) = (1 - p)^2 $, and $ freq(BB) = p^2 $. After natural selection, only the genotypes Bb and bb remain, and these now have frequencies of $$ \mathrm{freq}^{\prime}(Bb)=\frac{2p(1-p)}{1-p^{2}}=\frac{2p}{1+p}\quad and\quad\mathrm{freq}^{\prime}(bb)=\frac{(1-p)^{2}}{1-p^{2}}=\frac{1-p}{1+p} $$
> 
> Truncation selection occurs on the survivors of natural selection, generating a mixture distribution for the trait value (LW Chapter 13), with $$ \begin{aligned}z&=\mathrm{freq}^{\prime}(Bb)p_{Bb}(z)+\mathrm{freq}^{\prime}(bb)p_{bb}(z)\\&=\left(\frac{2p}{1+p}\right)p_{Bb}(z)+\left(\frac{1-p}{1+p}\right)p_{bb}(z)\end{aligned} $$
> 
...
## chapter25_025 · 25: Introduction / Accumulation of Lethals in Selected Lines
...
## chapter25_026 · 25: Introduction / Lerner's Model of Genetic Homeostasis
...
## chapter25_027 · 25: Introduction / Artificial Selection Countered by Natural Stabilizing Selection
