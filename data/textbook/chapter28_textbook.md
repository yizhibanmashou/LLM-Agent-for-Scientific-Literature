...
## chapter28_003 · Maintenance of Quantitative Genetic Variation: Introduction / Maintaining Genetic Variation for Quantitative Traits
...
## chapter28_005 · Maintenance of Quantitative Genetic Variation: Introduction / Mutational Models and Quantitative Variation
...
## chapter28_007 · Maintenance of Quantitative Genetic Variation: Introduction / Fitness Models of Stabilizing Selection
...
## chapter28_008 · Maintenance of Quantitative Genetic Variation: Introduction / Stabilizing Selection on a Single Trait
...
## chapter28_009 · Maintenance of Quantitative Genetic Variation: Introduction / Stabilizing Selection on Multiple Traits
...
> 
> > **Formula (28.5b)** · `28.5b` · source: `chapter28_block_049` · Stabilizing Selection on Multiple Traits
> >
> > $$ \omega_{1}^{2}=\frac{\sigma_{z_{1}}^{2}[\omega_{2}^{2}+\sigma_{z_{2}}^{2}(1-\rho_{z}^{2})]}{\rho_{z}\sigma_{z_{2}}^{2}} $$
> 
> 
> Note that $ \omega_1^2 \to \infty $ (no selection) as $ |\rho_z| \to 0 $. Scaling both traits to have an environmental variance of one, then $ \sigma_{z_i}^2 = \sigma_{G_i}^2 + 1 $, where $ \sigma_{G_i}^2 $ is the (environmentally scaled) genetic variance of trait i. Using this scaling, Wagner rearranged Equation 28.5d to find a lower bound of
> 
> > **Formula (28.5c)** · `28.5c` · source: `chapter28_block_050` · Stabilizing Selection on Multiple Traits
> >
> > $$ \omega_{1}^{2}\geq2\omega_{2}^{2}(\sigma_{G_{1}}^{2}+1)^{2} $$
> 
> 
> This sets an upper limit on the strength of apparent stabilizing selection (as smaller $ \omega_1^2 $ values imply stronger selection), with $ \omega_1^2 $ increasing (selection becoming weaker) as the fraction of genetic variance in trait 1 increases. This is not surprising, as the apparent selection arises through the environmental component, which is decreased by increasing the genetic contribution.
> 
> What is surprising, however, is that the joint fitness for the genotypic values for both traits, $ (A_{1}, A_{2}) $, is
> 
> > **Formula (28.6)** · `28.6` · source: `chapter28_block_052` · Stabilizing Selection on Multiple Traits
> >
> > $$ W(A_{1},A_{2})=\exp\left(-\frac{A_{2}^{2}}{2[\omega_{2}^{2}+\sigma_{E_{2}}^{2}]}\right) $$
> 
> 
> showing that there is no selection on the genotypic values of trait 1, which therefore evolves neutrally. Hence, the equilibrium heritability in trait 1 is entirely independent of the strength of the apparent selection on trait 1 (i.e., $ \omega_1^2 $ does not appear in this expression).


---

## chapter28_010 · Maintenance of Quantitative Genetic Variation: Introduction / Stabilizing Selection Countered by Pleiotropic Overdominance
...
## chapter28_011 · Maintenance of Quantitative Genetic Variation: Introduction / Fluctuating and Frequency-dependent Stabilizing Selection
...
## chapter28_012 · Maintenance of Quantitative Genetic Variation: Introduction / Summary of Direct-selection Models
...
> **Example 28.2** · ref: `28.2` · source: `chapter28_013.json` · blocks 4–4
>
...
> 
> Our starting point is Barton’s (and Robertson’s 1956) demonstration that the overdominance model with fitnesses of $ 1 - t_i: 1: 1 - s_i $ (and phenotypic effects of $ -a: 0: a $) generates a strength of apparent stabilizing selection on the neutral focal trait of
> 
> > **Formula (28.10a)** · `28.10a` · source: `chapter28_block_068` · NEUTRAL TRAITS WITH PLEIOTROPIC OVERDOMINANCE
> >
> > $$ V_{s}\simeq\sigma_{A}^{2}/\overline{{\ell}} $$
> 
> 
> where $ \sigma_A^2 $ is the focal-trait additive variance, $ \bar{\ell} $ is the average of the locus-specific segregation loads (the reduction in fitness from the optimal value) where
> 
> > **Formula (28.10b)** · `28.10b` · source: `chapter28_block_068` · NEUTRAL TRAITS WITH PLEIOTROPIC OVERDOMINANCE
> >
> > $$ \ell_{i}=\frac{s_{i}t_{i}}{s_{i}+t_{i}}\simeq\frac{s_{i}}{2}\quad when\quad s_{i}\simeq t_{i} $$
> 
> 
> and $1-\ell_i$ is the equilibrium mean fitness at locus $i$. Equation 28.10a implies that $\ell=0.05$ for a trait to have a typically assumed value of $V_s=20\sigma_A^2$. Assuming $n$ independent overdominant loci and multiplicative fitnesses, the expected mean population fitness becomes $$ \prod_{i=1}^{n}(1-\ell_{i})\simeq\exp(-\overline{\ell}n) $$
> 
> For $ \ell = 0.05 $, around 20 such loci will result in the mean population fitness being about a third of its maximum possible value, so the number of such loci has to be modest for the load to remain reasonable. If loci have weaker effects $ (\ell < 0.05) $, more polymorphisms can be maintained, but Equation 28.10a shows that the associated strength of apparent stabilizing selection on the neutral trait will be correspondingly weaker ($ V_s $ is larger).
> 
...
## chapter28_015 · Maintenance of Quantitative Genetic Variation: Introduction / Latter-Bulmer Diallelic Models
...
## chapter28_016 · Maintenance of Quantitative Genetic Variation: Introduction / Kimura-Lande-Fleming Continuum-of-alleles Models
...
## chapter28_017 · Maintenance of Quantitative Genetic Variation: Introduction / Gaussian Versus House-of-Cards Approximations for Continuum-of-alleles Models
...
> **Example 28.15** · ref: `28.15` · source: `chapter28_017.json` · blocks 4–4
>
...
## chapter28_020 · Maintenance of Quantitative Genetic Variation: Introduction / Effects of Linkage and Mating Systems
...
## chapter28_021 · Maintenance of Quantitative Genetic Variation: Introduction / Spatial and Temporal Variation in the Optimum
...
## chapter28_022 · Maintenance of Quantitative Genetic Variation: Introduction / Summary: Implications of Gaussian Versus HCA Approximations
...
> 
> > **Formula (28.21a)** · `28.21a` · source: `chapter28_block_121` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \frac{\partial p(x)}{\partial t}(\mathrm{sel})=\frac{-p(x)[x^{2}-\sigma^{2}(x)]}{2V_{s}} $$
> 
> 
...
> 
> > **Formula (28.21b)** · `28.21b` · source: `chapter28_block_122` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \frac{\partial p(x)}{\partial t}(\mathbf{m u t})=-\mu p(x)+\mu\int p(x-\alpha)f(\alpha)d\alpha $$
> 
> 
...
> 
> > **Formula (28.22a)** · `28.22a` · source: `chapter28_block_126` · Summary: Implications of Gaussian Versus HCA Approximations
> >
...
> 
> > **Formula (28.22c)** · `28.22c` · source: `chapter28_block_127` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \frac{-p(x)[x^{2}-\sigma^{2}(x)]}{2V_{s}}+\frac{\mu\sigma_{\alpha}^{2}}{2}\frac{\partial^{2}p(x)}{\partial^{2}x}=0 $$
> 
> 
> Kimura (1965a) showed that this equation is satisfied when $ p(x) $ follows a normal distribution, with the parameters
> 
> > **Formula (28.22d)** · `28.22d` · source: `chapter28_block_128` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ p(x)\sim N\left(0,\sqrt{\mu\sigma_{\alpha}^{2}V_{s}}\right) $$
> 
...
> **Example 28.5** · ref: `28.5` · source: `chapter28_023.json` · blocks 3–3
>
...
> 
> > **Formula (28.23a)** · `28.23a` · source: `chapter28_block_132` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \frac{-p(x)[x^{2}-\sigma^{2}(x)]}{2V_{s}}-\mu p(x)+\mu f(x)=0 $$
> 
> 
> which has an immediate solution of
> 
> > **Formula (28.23b)** · `28.23b` · source: `chapter28_block_132` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ p(x)=\frac{2V_{s}\mu f(x)}{x^{2}-\sigma^{2}(x)+2V_{s}\mu} $$
> 
> 
> As noted by Bulmer (1989), the $ \sigma^{2}(x) $ term—the variance in allelic effects, $ \sigma^{2}(a) $—is a constant that can be found by noting that $ \int p(x)dx = 1 $, as $ p(x) $ is a probability density function. Hence, for a given choice of $ f(x) $, one integrates Equation 27.23b, and then solves for the value of $ \sigma^{2}(x) $ that returns an integral of one.
> 
> If $ x^2 \gg \sigma^2(x) + 2V_s\mu $, then
> 
> > **Formula (28.23c)** · `28.23c` · source: `chapter28_block_133` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ p(x)\simeq\frac{2V_{s}\mu f(x)}{x^{2}} $$
> 
> 
> Under this approximation, the expected value of $ x^{k} $
> 
> > **Formula (28.23d)** · `28.23d` · source: `chapter28_block_134` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \begin{align*}E[x^k]=\int x^kp(x)dx=\int x^k{2V_s\mu f(x)\over x^2}dx=2V_s\mu E[\alpha^{k-2}]\end{align*} $$
> 
> 
> namely, a function of the expected $ k - 2 $ power of the mutational effects ($ \alpha $). Hence, setting $ k $ equal to 2 and 4, respectively, yields the equilibrium variance and kurtosis of allelic effects for locus $ i $ as $$ \sigma^{2}(a_{i})\simeq2V_{s}\mu_{i}E[\alpha_{i}^{0}]=2V_{s}\mu_{i}\cdot1\quad\mathrm{a n d}\quad E[x_{i}^{4}]\simeq2V_{s}\mu_{i}E[\alpha_{i}^{2}]=2V_{s}\mu_{i}\sigma_{\alpha_{i}}^{2} $$
> 
> Upon recalling that $ \sigma_{A(i)}^2 = 2\sigma^2(a_i) $, this first expression recovers Equation 28.18a, while the second expression yields Equation 28.18c.


**[示例 Example]**

> **Example 28.6** · ref: `28.6` · source: `chapter28_023.json` · blocks 4–4
>
> Example 28.6. An intermediate model between Kimura's Gaussian and Turelli's HCA approximations was offered by Slatkin (1987), and our derivation here is based on his work, as well as that of Bulmer (1989). As with many of the above analyses, we start with a single-locus haploid model, which is extended to a diploid multilocus result by assuming additivity and no significant linkage effects. While our initial focus is on a single locus, the model now has multiple alleles, which we index by the subscript j. Further, our focus shifts from the distribution of allelic effects, $ p(x) $ (from the previous example), to the frequency, $ p_j $, of allele j. Again, the trait is scaled so that the optimum $ \theta = 0 $, and we assume that the current phenotypic mean resides at the optimum. Slatkin assumed a stepwise (as opposed to a continuum) series of alleles, where $ A_j $ mutates to either $ A_{j-1} $ or $ A_{j+1} $, each with rate $ \mu/2 $ (independent of allelic state, j). Further, let us assume that allele $ A_j $ has effect $ a \cdot j $. In that case Slatkin showed that the expected allele-frequency change from selection becomes
> 
> > **Formula (28.24a)** · `28.24a` · source: `chapter28_block_136` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \frac{\partial p_{j}}{\partial t}(\mathrm{sel})=-\frac{p_{j}[a^{2}j^{2}-\sigma^{2}(x)]}{2V_{s}} $$
> 
> 
...
> 
> > **Formula (28.24b)** · `28.24b` · source: `chapter28_block_136` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \frac{\partial p_{j}}{\partial t}(\mathbf{m u t})=-\mu p_{j}+\frac{\mu}{2}\left(p_{j-1}+p_{j+1}\right) $$
> 
> 
> Hence, at equilibrium,
> 
> > **Formula (28.24c)** · `28.24c` · source: `chapter28_block_137` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ -\frac{p_{j}[a^{2}j^{2}-\sigma^{2}(x)]}{2V_{s}}+\frac{\mu}{2}\bigg(p_{j-1}-2p_{j}+p_{j+1}\bigg)=0 $$
> 
> 
> The mutation term in Equation 28.24c is a second-degree difference equation, which, in the limit, approaches a second derivative, as $$ \begin{aligned}&\lim_{\delta\rightarrow0}\left(\frac{f(x-\delta)-2f(x)+f(x+\delta)}{\delta}\right)\\=&\lim_{\delta\rightarrow0}\left(\frac{[f(x-\delta)-f(x)]-[f(x)-f(x+\delta)]}{\delta}\right)\rightarrow\frac{d^{2}f(x)}{dx^{2}}\end{aligned} $$
...
> 
> > **Formula (28.25c)** · `28.25c` · source: `chapter28_block_140` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ C_{i j}(t+1)=(1-r_{i j})C_{i j}(t)_{s}+r_{i j}B_{i j}(t)+\delta_{i j}\mu_{i}\sigma_{\alpha_{i}}^{2} $$
> 
> 
> The last term accounts for mutation, while the first two account for recombination as follows. With probability $ 1 - r_{ij} $, loci i and j do not recombine, passing their covariance after selection, $ C_{ij}(t)_s $, to their gametes, while with probability $ r_{ij} $ recombination does occur, with the covariance between $i$ and $j$ in a gamete equaling the between-gamete covariance following selection, $B_{ij}(t)$. (A notational aside is that, as in Chapter 24, we depart from using $c_{ij}$ and instead use $r_{ij}$ for recombination rates to avoid confusion with the $C_{ij}$ terms.) Because the Cij(t) determine the additive variance at generation t, let
> 
> > **Formula (28.25d)** · `28.25d` · source: `chapter28_block_141` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ 2C_{i}(t)=2\sum_{j=1}^{n}C_{ij}(t) $$
> 
> 
...
> 
> > **Formula (28.26b)** · `28.26b` · source: `chapter28_block_144` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \mathbf{K}(t)=\begin{pmatrix}\mathbf{C}_{s}(t)&\mathbf{B}(t)\\ \mathbf{B}(t)&\mathbf{C}_{s}(t)\end{pmatrix} $$
> 
> 
> and the task is to compute the elements of $ \mathbf{K}(t) $. Under Gaussian stabilizing selection (with an optimal value of zero), the fitness of individuals with genotypic value $ g = \sum(x_i + x_i') $ is
> 
> > **Formula (28.26c)** · `28.26c` · source: `chapter28_block_144` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ W(g)=\exp\left(-\left[\sum_{i=1}^{n}(x_{i}+x_{i}^{\prime})\right]^{2}\bigg/(2V_{s})\right)=\exp\left(-\frac{\mathbf{x}\mathbf{1}\mathbf{x}^{T}+2\mathbf{x}^{\prime}\mathbf{1}\mathbf{x}^{T}+\mathbf{x}^{\prime}\mathbf{1}(\mathbf{x}^{\prime})^{T}}{2V_{s}}\right) $$
> 
> 
...
> 
> > **Formula (28.26d)** · `28.26d` · source: `chapter28_block_145` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ p(\mathbf{x})p(\mathbf{x}^{\prime})W\left[\sum(x_{i}+x_{i}^{\prime})\right] $$
> 
> 
> Because all three terms contain exponentials of quadratic products, the resulting exponential term is the sum of the quadratic products. The quadratic product in W is given by Equation 28.26c, while the two quadratic products associated with the MVN density functions are of the form $ [\mathbf{x} - \boldsymbol{\mu}] \mathbf{C}^{-1} [\mathbf{x} - \boldsymbol{\mu}]^T $ (LW Equation 8.24). Because the remaining terms are constants with respect to $ \mathbf{x} $ and $ \mathbf{x}' $, the product given by Equation 28.26d is proportional to $ \exp(-F/2) $, where $ F $ equals the sum of the quadratic products
> 
> > **Formula (28.26e)** · `28.26e` · source: `chapter28_block_145` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ [\mathbf{x}-\boldsymbol{\mu}(t)]\mathbf{C}^{-1}(t)[\mathbf{x}-\boldsymbol{\mu}(t)]^{T}+[\mathbf{x}^{\prime}-\boldsymbol{\mu}(t)]\mathbf{C}^{-1}(t)[\mathbf{x}^{\prime}-\boldsymbol{\mu}(t)]^{T}+\frac{\mathbf{x}\mathbf{1}\mathbf{x}^{T}+2\mathbf{x}^{\prime}\mathbf{1}\mathbf{x}^{T}+\mathbf{x}^{\prime}\mathbf{1}(\mathbf{x}^{\prime})^{T}}{V_{s}} $$
> 
> 
> Because the resulting distribution of allelic effects after selection is also MVN with co-variance matrix K, it has an associated quadratic product of
> 
> > **Formula (28.26f)** · `28.26f` · source: `chapter28_block_145` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \begin{pmatrix}\mathbf{x}-\boldsymbol{\mu}(t)\\\mathbf{x}^{\prime}-\boldsymbol{\mu}(t)\end{pmatrix}\mathbf{K}^{-1}\begin{pmatrix}\mathbf{x}-\boldsymbol{\mu}(t)\\\mathbf{x}^{\prime}-\boldsymbol{\mu}(t)\end{pmatrix}^{T} $$
> 
> 
> Our task is to find the value of K such that Equation 28.26f recovers Equation 27.26e. Matching terms yields
> 
> > **Formula (28.26g)** · `28.26g` · source: `chapter28_block_146` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \mathbf{K}^{-1}(t)=\begin{pmatrix}\mathbf{C}^{-1}(t)+\mathbf{1}/V_{s}&\mathbf{1}/V_{s}\\\mathbf{1}/V_{s}&\mathbf{C}^{-1}(t)+\mathbf{1}/V_{s}\end{pmatrix} $$
> 
> 
> Lande noted that because $ KK^{-1} = I $, Equations 28.26b and 28.26e imply
> 
> > **Formula (28.26h)** · `28.26h` · source: `chapter28_block_147` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \left(\begin{array}{c c}{\mathbf{C}_{s}(t)}&{\mathbf{B}(t)}\\ {\mathbf{B}(t)}&{\mathbf{C}_{s}(t)}\end{array}\right)\left(\begin{array}{c c}{\mathbf{C}^{-1}(t)+\mathbf{1}/V_{s}}&{\mathbf{1}/V_{s}}\\ {\mathbf{1}/V_{s}}&{\mathbf{C}^{-1}(t)+\mathbf{1}/V_{s}}\end{array}\right)=\left(\begin{array}{c c}{\mathbf{I}}&{\mathbf{0}}\\ {\mathbf{0}}&{\mathbf{I}}\end{array}\right) $$
> 
> 
> Solving this system of equations gives
> 
> > **Formula (28.27a)** · `28.27a` · source: `chapter28_block_148` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \mathbf{C}_{s}(t)=\frac{1}{2}\Big(\mathbf{C}^{-1}(t)+2\cdot\mathbf{1}/V_{s}\Big)^{-1}+\frac{1}{2}\mathbf{C}(t) $$
> 
> 
> > **Formula (28.27b)** · `28.27b` · source: `chapter28_block_148` · Summary: Implications of Gaussian Versus HCA Approximations
> >
...
> 
> > **Formula (28.29a)** · `28.29a` · source: `chapter28_block_157` · Summary: Implications of Gaussian Versus HCA Approximations
> >
...
> 
> > **Formula (28.29b)** · `28.29b` · source: `chapter28_block_157` · Summary: Implications of Gaussian Versus HCA Approximations
> >
...
> 
> 
> where $\Gamma$ denotes the gamma function (Equation A2.26a) extended into the complex plane (with $i = \sqrt{-1}$). The parameter $\beta = 2\tilde{\sigma}^2(a)/\sigma_\alpha^2$ is the ratio of the equilibrium variance in allelic effects, $\tilde{\sigma}^2(a)$, to the variance of mutational increments, $\sigma_\alpha^2$. Waxman found that
> 
> > **Formula (28.29c)** · `28.29c` · source: `chapter28_block_157` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \widetilde{\sigma}^{2}(a)=\frac{\sigma_{\alpha}^{2}}{4}\left(\sqrt{1+\frac{16\mu V_{s}}{\sigma_{\alpha}^{2}}}-1\right) $$
> 
> 
...
> 
> A complementary extension of Waxman’s result is provided by the House-of-Gauss (HG) model of Hermisson and Wagner (2004). They assumed weak stabilizing selection around an optimum of $ \theta = 0 $, so that we can write the fitness as $ W(z) = 1 - z^2/(2V_s) $. Under these assumptions, the equilibrium additive-genetic variance can be expressed in terms of cumulants (Chapter 24) of the distribution of allelic effects, with
> 
> > **Formula (28.29d)** · `28.29d` · source: `chapter28_block_159` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \frac{2\widetilde{\sigma}^{4}(a)+\widetilde{K}_{4}}{2V_{s}}=\mu\sigma_{\alpha}^{2} $$
> 
> 
> at equilibrium, representing the balance between the removal of variation by selection (left-hand side) and its introduction by new mutations (right-hand side). The Gaussian assumption is that the equilibrium fourth-order cumulant $ \widetilde{K}_4 = \widetilde{\mu}_4(a) - 3\widetilde{\sigma}^4(a) $ (Equation 24.20) is small relative to $ \widetilde{\sigma}^4(a) $, in which case solving Equation 28.29d recovers Kimura's haploid variance (Equation 28.14a). Under the HCA, Equation 28.18d shows that $ \widetilde{K}_4 $ is replaced by $ \sigma_a^2\widetilde{\sigma}^2(a) $ and the $ \widetilde{\sigma}^4(a) $ term is ignored (the rare-alleles approximation discussed in Example 24.11), in which case Equation 28.29d recovers the haploid HCA variance (Equation 28.12a). The House-of-Gauss approximation (HGA) retains $ \widetilde{\sigma}^4(a) $ in Equation 28.29d (the Gaussian approximation) while replacing $ \widetilde{K}_4 $ by its HCA, $ \sigma_a^2\sigma^2(a) $, which changes Equation 28.29d to
> 
> > **Formula (28.29e)** · `28.29e` · source: `chapter28_block_159` · Summary: Implications of Gaussian Versus HCA Approximations
> >
> > $$ \begin{align*}2\widetilde{\sigma}^4(a)+\sigma^2_\alpha\widetilde{\sigma}^2(a)=2V_s\mu\sigma^2_\alpha\end{align*} $$
> 
> 
...
## chapter28_026 · Maintenance of Quantitative Genetic Variation: Introduction / Impact on Equilibrium Variances
...
## chapter28_027 · Maintenance of Quantitative Genetic Variation: Introduction / Near Neutrality at the Underlying Loci?
...
## chapter28_029 · Maintenance of Quantitative Genetic Variation: Introduction / Gaussian Results
...
> **Example 28.9** · ref: `28.9` · source: `chapter28_029.json` · blocks 8–8
>
...
## chapter28_030 · Maintenance of Quantitative Genetic Variation: Introduction / HCA Results
...
> **Example 28.10** · ref: `28.10` · source: `chapter28_030.json` · blocks 8–8
>
...
> 
> > **Formula (28.43a)** · `28.43a` · source: `chapter28_block_196` · HCA Results
> >
> > $$ s_{i}\simeq\frac{\alpha^{T}\mathbf{V}_{s}^{-1}\alpha}{2} $$
> 
> 
> This is the multivariate equivalent of Equation 28.4c. When $ V_s $ is diagonal (uncorrelated selection; Example 28.9), this reduces to
> 
> > **Formula (28.43b)** · `28.43b` · source: `chapter28_block_197` · HCA Results
> >
> > $$ s_{i}\simeq\sum_{j=1}^{k}\frac{\alpha_{j,i}^{2}}{2V_{s,j}},\quad\mathrm{i m p l y i n g}\quad E[s_{i}]\simeq\sum_{j=1}^{k}\frac{\sigma_{\alpha_{j,i}}^{2}}{2V_{s,j}}=\sum_{j=1}^{k}E[s_{j,i}] $$
> 
> 
> namely, the sum of the average selection coefficients of a new mutation associated with each of the k traits. More generally, expanding the quadratic product given by Equation 28.43a yields $$ s_{i}\simeq\sum_{j=1}^{k}\sum_{\ell=1}^{k}\alpha_{j,i}\cdot V_{j,\ell}\cdot\alpha_{\ell,i} $$ where $ V_{j,\ell} $ is the $ j\ell $th element of $ V_{s}^{-1} $. Taking expectations yields
> 
> > **Formula (28.43c)** · `28.43c` · source: `chapter28_block_197` · HCA Results
> >
> > $$ E[s_{i}]\simeq\sum_{j=1}^{k}\sum_{\ell=1}^{k}\left[V_{j,\ell}\cdot\sigma(\alpha_{k,i},\alpha_{\ell i})\right] $$
> 
> 
> Zhang and Hill (2003) noted that if all $n$ traits impact locus $i$ with roughly similar selection coefficients ($E[s_{j,i}] \simeq s_i$), then from the central limit theorem, the distribution of the $s_i$ approaches a normal. Further, the coefficient of variation of this distribution goes to zero at an approximate rate of $\sqrt{(3\kappa_{4,s} - 1)/n}$, where $\kappa_{4,s} = E[(s_i - \bar{s}_i)^4] / \{3(\sigma^2(s_i)^2\} \text{ is the scaled kurotsis of } s_i$. Thus, for a sufficiently large number of independent traits under selection, $s_i$ is approximately a constant plus a small amount of normally distributed error.
...
## chapter28_032 · Maintenance of Quantitative Genetic Variation: Introduction / The Hill-Keightley Pleiotropic Side-effects Model
...
> **Example 28.11** · ref: `28.11` · source: `chapter28_034.json` · blocks 2–2
>
...
> **Example 28.12** · ref: `28.12` · source: `chapter28_034.json` · blocks 3–3
>
...
> 
> Caballero and Keightley (1994) used these P-factor mutational values to parameterize an (α-reflected) bivariate gamma distribution (s ≤ 0; −∞ < α < ∞), which was then used to generate an α and s value for a new mutation. These authors used $ N_e = 10^4 $, and hence an average number of $ 2N_e\mu = 2000 $ new mutations per generation, with the bivariate effects of each new mutation drawn from the aforementioned distribution. These simulations returned an equilibrium heritability of 0.4. A closer look at the architecture of the mutations generated in the simulations showed that the vast majority (87%) of these were highly deleterious ($ N_e s < -30 $). The table below gives the expected number of mutations (each generation) in various (s, α) classes, and the percentage of total additive-genetic trait variance attributable to each class. For example, in their simulations, on average 7 slightly deleterious mutations (−1 ≤ N_e s ≤ 0) arose in each generation, with an effect of 0.125–0.25 standard deviations on the trait. Such mutations account for roughly 13% of the equilibrium additive-genetic variance.
> 
...
## chapter28_036 · Maintenance of Quantitative Genetic Variation: Introduction / Deleterious Pleiotropy-stabilizing Selection (Joint-effects) Models
...
## chapter28_038 · Maintenance of Quantitative Genetic Variation: Introduction / Example 28.15. As an application of the joint-effects model, suppose that

$$ V_{s}=100\sigma_{E}^{2},\quad\overline{s}_{p}=0.005,\quad\sigma_{m}^{2}=\sigma_{E}^{2}/10^{3},\quad and\quad2n\mu=0.01 $$

Thus, $ \sigma_a^2 = \sigma_m^2 / (2n\mu) = 0.1 $ and $ \overline{s}_d = \sigma_a^2 / (2V_s) = 0.1 / (200) = 5 \cdot 10^{-5} $ (Equation 28.30d), so that $ \overline{s}_d \ll \overline{s}_p $. Under HCA (Equation 28.18a), the equilibrium additive variance is $ 4n\mu V_s = 0.02 \cdot 100 \sigma_E^2 = 2 \sigma_E^2 $, while under pure pleiotropy (Equation 28.45b), it is $ \sigma_m^2 / \overline{s}_p = 10^{-3} \sigma_E^2 / 0.005 = 0.2 \sigma_E^2 $. Applying Equation 28.52d, the equilibrium variance under the joint-effects model becomes $ \sqrt{2 \cdot 0.2 \cdot \sigma_E^2} = 0.63 \sigma_E^2 $, for a heritability of $ 0.63 / (1 + 0.63) = 0.39 $. Because $ \overline{s}_d \ll \overline{s}_p $, the strength of apparent stabilizing selection is given by $ \widehat{V}_s^* $ (Equation 28.50d). $$ \widehat{V}_{s}^{*}/\sigma_{E}^{2}=\frac{0.63/0.005}{0.63/(100\cdot0.005)+1}=55.7 $$
...
## chapter28_040 · Maintenance of Quantitative Genetic Variation: Introduction / Strength of Selection: Direct Selection on a Trait
...
> **Example 28.16** · ref: `28.16` · source: `chapter28_040.json` · blocks 5–5
>
...
## chapter28_041 · Maintenance of Quantitative Genetic Variation: Introduction / Strength of Selection: Persistence Times of New Mutants
...
## chapter28_042 · Maintenance of Quantitative Genetic Variation: Introduction / Number of Loci and Mutation Rates
...
## chapter28_044 · Maintenance of Quantitative Genetic Variation: Introduction / Accelerated Responses in Artificial Selection Experiments
...
## chapter28_045 · Maintenance of Quantitative Genetic Variation: Introduction / Kelly's Test for Rare Recessives
