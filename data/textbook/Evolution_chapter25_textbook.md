...
*[See Table 25.1 at the end of this section.]* for $ p_{\beta} $, with $ m(1) $ is replaced by $ m(\widehat{p}) $ when $ k > 1 $. A case of particular interest is $ p_{0.5} $, the frequency at which half of the expected response occurs ($ \beta = 1/2 $). Expressions for $ p_{0.5} $ as a function of initial allele frequency are given in *[See Table 25.1 at the end of this section.]* and plotted in Figure 25.3. Observe that rare recessives have to increase substantially in frequency to yield half their ultimate response (e.g., for $ k = -1 $, $ p_{0.5} \simeq 0.71 $ when $ p_0 = 0.1 $).
...
Recall that the results for the single-locus selection response in Chapter 5 used the fitness parameterization where the genotypes $ bb: Bb: BB $ have fitnesses $ 1:1 + s(1 + h):1 + 2s $. For weak selection (e.g., $ |s|, |sh| \ll 1 $), this model gives the change in the frequency of B as

$$
\Delta p\simeq s p\left(1-p\right)\left[1+h\left(1-2p\right)\right]
$$

which follows from Equation 5.1c upon noting that $ 1/\bar{W} = 1 + O(s, sh) $, namely, one plus terms of order s and sh. Upon matching terms with Equation 25.3, we find that a QTL under directional selection has approximate selection parameters of
...
$$
\begin{aligned}\overline{W}&=(1-p)^{2}W {bb}+2p(1-p)W {Bb}+p^{2}W {BB}\\&=(1-p)^{2}\overline{W} {0}+2p(1-p)(1-s {1})\overline{W} {1}+p^{2}(1-s {2})\overline{W} {2}\end{aligned}
$$

**[推导 Derivation]**

$$
\overline{z}=\mu\left(1+2\alpha {1}p(1-p)+\alpha {2}p^{2}\right)
$$
...
Following the loss of lethal homozygotes in the surviving offspring, $ \hat{p} $ decreases to

**[推导 Derivation]**

$$
\widetilde{p}=\frac{(1/2)\mathrm{freq}(Bb)}{\mathrm{freq}(Bb)+\mathrm{freq}(bb)}=\frac{\widehat{p}(1-\widehat{p})}{2\widehat{p}(1-\widehat{p})+(1-\widehat{p})^{2}}=\frac{\widehat{p}}{1+\widehat{p}}
$$
...
From *[See Table 25.2 at the end of this section.]*, the new mean becomes
...
## Evolution_chapter25_009 · MAJOR GENES VERSUS POLYGENIC RESPONSE: DATA
...
## Evolution_chapter25_010 · MAJOR GENES VERSUS POLYGENIC RESPONSE: DATA / Major Genes Appear to Be Important in Response to Anthropogenically Induced Selection
...
## Evolution_chapter25_011 · MAJOR GENES VERSUS POLYGENIC RESPONSE: DATA / What is the Genetic Architecture of Response in Long-term Selection Experiments?
...
## Evolution_chapter25_012 · AN OVERVIEW OF LONG-TERM SELECTION EXPERIMENTS
...
## Evolution_chapter25_013 · AN OVERVIEW OF LONG-TERM SELECTION EXPERIMENTS / Estimating Selection Limits and Half-lives
...
*[See Table 25.3 at the end of this section.]*

> **Table 25.3** · `25.3` · page 20 · source: `Evolution_chapter25_013`
...
## Evolution_chapter25_014 · AN OVERVIEW OF LONG-TERM SELECTION EXPERIMENTS / General Features of Long-term Selection Experiments
...
5. Considerable additive variance in the trait under artificial selection often exists at an apparent selection limit (*[See Table 25.4 at the end of this section.]*).
...
## Evolution_chapter25_016 · AN OVERVIEW OF LONG-TERM SELECTION EXPERIMENTS / The Nature of Selection Limits
...
*[See Table 25.4 at the end of this section.]*

> **Table 25.4** · `25.4` · page 24 · source: `Evolution_chapter25_016`
...
## Evolution_chapter25_017 · INCREASES IN VARIANCES AND ACCELERATED RESPONSES
...
## Evolution_chapter25_018 · INCREASES IN VARIANCES AND ACCELERATED RESPONSES / Rare Alleles
...
## Evolution_chapter25_019 · INCREASES IN VARIANCES AND ACCELERATED RESPONSES / Major Mutations
...
## Evolution_chapter25_020 · INCREASES IN VARIANCES AND ACCELERATED RESPONSES / Scale and Environmental Impacts on Variances
...
## Evolution_chapter25_021 · INCREASES IN VARIANCES AND ACCELERATED RESPONSES / Linkage Effects
...
## Evolution_chapter25_022 · INCREASES IN VARIANCES AND ACCELERATED RESPONSES / Epistasis
...
## Evolution_chapter25_023 · CONFLICTS BETWEEN NATURAL AND ARTIFICIAL SELECTION
...
## Evolution_chapter25_026 · CONFLICTS BETWEEN NATURAL AND ARTIFICIAL SELECTION / Artificial Selection Countered by Natural Stabilizing Selection
