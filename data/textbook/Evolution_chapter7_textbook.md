...
## Evolution_chapter7_001 · Interaction of Selection, Mutation, and Drift: Introduction
...
## Evolution_chapter7_002 · Interaction of Selection, Mutation, and Drift: Introduction / SELECTION AND MUTATION AT SINGLE LOCI
...
$$
\begin{aligned}(1-\widetilde{p})^{3}s(2h-1)&+(1-\widetilde{p})^{2}[2-3h+\mu h+v(1-h)]\\&+(1-\widetilde{p})[-s(1-h)+\mu(1-hs)+v(1-2s+hs)]-v(1-s)=0\end{aligned}
$$
...
## Evolution_chapter7_003 · Interaction of Selection, Mutation, and Drift: Introduction / SELECTION AND DRIFT AT SINGLE LOCI
...
## Evolution_chapter7_004 · SELECTION AND DRIFT AT SINGLE LOCI / Probability of Fixation Under Additive Selection
...
> **Figure 7.1** · page 8 · source: `Evolution_chapter7`
>
> ![Figure 7.1](figures/Evolution_7.1.png)
>
...
> **Figure 7.2** · page 9 · source: `Evolution_chapter7`
>
> ![Figure 7.2](figures/Evolution_7.2.png)
>
...
## Evolution_chapter7_005 · SELECTION AND DRIFT AT SINGLE LOCI / Probability of Fixation Under Arbitrary Selection
...
## Evolution_chapter7_006 · SELECTION AND DRIFT AT SINGLE LOCI / Fixation of Overdominant and Underdominant Alleles
...
> **Figure 7.4** · page 14 · source: `Evolution_chapter7`
>
> ![Figure 7.4](figures/Evolution_7.4.png)
>
...
> **Figure 7.5** · page 16 · source: `Evolution_chapter7`
>
> ![Figure 7.5](figures/Evolution_7.5.png)
>
...
## Evolution_chapter7_007 · SELECTION AND DRIFT AT SINGLE LOCI / Expected Allele Frequency in a Particular Generation
...
These approximations provide a remarkably simple route to obtaining fixation probabilities under weak selection ($ N_e s \ll 1 $). Because an allele will ultimately be either fixed ($ p_\infty = 1 $) or lost ($ p_\infty = 0 $), the asymptotic mean frequency as $ t \to \infty $ is equal to the fixation probability
...
## Evolution_chapter7_008 · Interaction of Selection, Mutation, and Drift: Introduction / JOINT INTERACTION OF SELECTION, DRIFT, AND MUTATION
...
> **Figure 7.6** · page 19 · source: `Evolution_chapter7`
>
> ![Figure 7.6](figures/Evolution_7.6.png)
>
...
(Li 1987; Bulmer 1991; McVean and Charlesworth 1999). Strictly speaking, this expression applies to the weak-mutation limit (where $ N(\mu + v) \ll 1 $ ensures that polymorphisms are rare), so that $ \tilde{P}_{\text{opt}} $ denotes the fraction of time for which the site is fixed for the optimal nucleotide.
...
## Evolution_chapter7_009 · Interaction of Selection, Mutation, and Drift: Introduction / HALDANE'S PRINCIPLE AND THE MUTATION LOAD
...
## Evolution_chapter7_010 · Interaction of Selection, Mutation, and Drift: Introduction / FIXATION ISSUES INVOLVING TWO LOCI
...
## Evolution_chapter7_011 · FIXATION ISSUES INVOLVING TWO LOCI / The Hill-Robertson Effect
...
## Evolution_chapter7_012 · FIXATION ISSUES INVOLVING TWO LOCI / Mutations with Contextual Effects
...
## Evolution_chapter7_013 · FIXATION ISSUES INVOLVING TWO LOCI / Stochastic Tunneling
